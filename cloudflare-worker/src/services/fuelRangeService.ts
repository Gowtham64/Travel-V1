...
import { resolveLocation } from './fuelService';
...
class FuelRangeService {
   ...
   */
  static calculateSafeRange(theoreticalRangeKm: any, options: any = {}) {
   ...
   */
  static calculateRemainingFuel({ startingFuelLiters = 0, distanceTravelledKm = 0, efficiencyKmPerLiter = 15.0 }: any) {
   ...
   */
  static isDestinationReachable(safeRangeKm: any, distanceToDestinationKm: any) {
